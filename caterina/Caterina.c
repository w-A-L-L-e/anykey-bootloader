...
void CDC_Task(void)
{
  ...
  {
    //block write here until a shared secret is matched, later we will most likely change this into a handshake
    //use 8 bit integers to save flash space we need to be under 0x7fff in total adres space!
    //bootloader is from 0x7000 to 0x7FFF per atmel design doc and this is hard limits!
    uint8_t unlock_hash[]={
