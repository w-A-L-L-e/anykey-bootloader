...
/*
  ...
  Copyright 2019 Walter Schreppers : Minor modifications for AnyKey project and cleanup
*/
 ...
 *  process begins.
 */
const USB_Descriptor_Device_t DeviceDescriptor = {.Header = {.Size = sizeof(USB_Descriptor_Device_t), .Type = DTYPE_Device},
 ...
 */
const USB_Descriptor_String_t LanguageString = {.Header = {.Size = USB_STRING_LEN(1), .Type = DTYPE_String},
 ...
 *  Descriptor.
 */
const USB_Descriptor_String_t ProductString = {.Header = {.Size = USB_STRING_LEN(16), .Type = DTYPE_String},
