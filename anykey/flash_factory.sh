...
DEVICE=`ls -1 /dev/cu.usb*`
avrdude -v -carduino -patmega32u4 -P$DEVICE -b 19200 -Uflash:w:anykey_bootloader.hex:i  -U lfuse:w:0xFF:m	-U hfuse:w:0xD8:m	-U efuse:w:0xCB:m	
